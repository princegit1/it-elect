...
public class ShowXmlData extends HttpServlet {
	...
	ArrayList parseData = (ArrayList)db.getParsedData(stateName);
	...
	RequestDispatcher dispatcher = request.getRequestDispatcher("statetally.jsp");
