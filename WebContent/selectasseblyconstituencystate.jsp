...
try
		{	
		upQuery="SELECT distinct(STATE_NAME) from constituency_master where ASSEMBLY='1'and ACTIVE='1' and STATE_NAME in('assam','kerala','puducherry','tamil nadu','west bengal')";
		//System.out.println("selectasseblyconstituencystate.jsp:: upQuery: "+upQuery);
...
<body>
	<form action="showassemblyconstituencydata" method="post">
		<table width="421" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="51" valign="top"
					...
					<table width="421" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="143" height="26" class="statewhitetext1">Constituency
							</td>
							<td colspan="2" height="26" valign="top" align="right">
								<div style="margin-right: 10px;">
									<SELECT name=state id="select" class="statelistbox1"
										...
										<% while(rs.next()) {
			st1= rs.getString("STATE_NAME").trim();
