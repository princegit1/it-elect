...
try
		{	
	upQuery="SELECT distinct(STATE) from vip_master where ASSEMBLY='1' and  ACTIVE='1' and STATE in('assam','kerala','puducherry','tamil nadu','west bengal')";

		//System.out.println("selectvipstatewise.jsp:: upQuery: "+upQuery);
...
<body>
	<form action="showvipdata" method="post">
