...
try
		{	
		upQuery="SELECT distinct(STATE_NAME) from constituency_master where active='1' and ASSEMBLY='1' order by STATE_NAME";
...
<body>
	<form action="showconstituencydata" method="post">
		<table width="421" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="51" valign="top"
					...
					<table width="421" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="170" height="26" class="statewhitetext1">Constituency
								Tally</td>
